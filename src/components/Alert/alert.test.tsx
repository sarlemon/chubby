...
describe('test Alert Component', () => {
  it('should render the correct default Alert', () => {
    ...
    expect(container.querySelector('.chubby-alert')).toHaveClass('chubby-alert-default')
  ...
  it('should render the correct Alert based on different type and description', () => {
    ...
    expect(container.querySelector('.chubby-alert')).toHaveClass('chubby-alert-success')
